...
require_once('../../models/handler/registro_handler.php');
/*
*	Clase para manejar el encapsulamiento de los datos de la tabla CLIENTE.
*/
class RegistroData extends RegistroHandler
{
    ...
    */
    ...
    public function setCorreo($value, $min = 8, $max = 35)
    {
    ...
    public function setTelefono_movil($value)
    {
    ...
    public function setTelefono_fijo($value)
    {
        if (Validator::validatePhone($value)) {
